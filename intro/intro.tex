...
Predictive modeling of biological data ranges from abstract 
...
logic and other methods lying in between. 
...
\section{Network}
The difficulty of identifying biomarkers to diagnose diseases, stratify patients, and predict responses to therapies is
...
Similarly, consciousness cannot be reduced to a single 
...
\emph{edgetic} perturbations at the other~\citep{Zhong2009}. The
...
propose a two-step approach that separates two distinct 
...
usefulness of both metrics is demonstrated in a study of
