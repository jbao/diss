...
, they are further made sure to be connected.

\subsubsection{Dynamics}
We adapted a thermodynamical gene network model 
(\citealp{Marbach2010,Schilstra2002,Schaffter2011}),
...
then regenerated, but kinetic parameters were kept the same. 
...
regulated and responsible for signal transduction. This 
feature can be considered as an \emph{elephant in the room},
...
we learned, if one starts to reconstruct the network consisting only of
