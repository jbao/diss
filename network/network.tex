...
From a biological perspective, cells might also have
...
We measured
the gene expression profiles in keratinocytes up to 8h after the treatment of HGF (\citealp{Busch2008}) 
and identified
...
(transforming growth factor beta receptor 1) and EGFR 
(epidermal growth factor receptor), and 8 top responders. It is again confirmed that
...
As an \emph{in vitro} verification, the scratch assay was performed
...
of strong regulators were added to 
...
It has been shown that the perturbation of all the above top responding players can reduce the closed migration 
...
We further identified 3 genes that only show up in the MDS-based ranking.
