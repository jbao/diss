...
The enhancement of cell migration in the coculture of H838
and HPAEC cells correlates with the differential upregulation 
of cancer and metastasis related gene sets in H838 cells 
over time. 
There are correspondingly a small number of, and less specific downregulated gene sets, which fits the hypothesis of 
a specific transcriptional program underlying the phenotype
(\ref{sec:h838_gage_table}). 
...
\begin{center}
\captionsetup{labelformat=prepage}
\includegraphics[width=\textwidth]{h838-tf_heatmap.pdf}
\newpage
\captionof{figure}[Enrichment of transcription factors]{
{\bf Enrichment of transcription factor target genes in
the H838 cells cocultured with HPAEC at each time point.} 
Black squares indicate the over-representation of the  
