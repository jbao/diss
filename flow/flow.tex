...
We further set out to compare both shortest path length (SP) and mean first 
...
\begin{figure}[!ht]
\begin{center}
\includegraphics[width=\textwidth]{h838-mfpt_ts_0_6.pdf}
\end{center}
...
As a result, receptors with both a short distance and a low
...
signal flow in the tumor cell. Over time, the ligands get
internalized, which forces the endothelial cell to 
