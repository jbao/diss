...
or efficient way,
shortest path length between two nodes in the network is a classical way to
...
\section{Application in tumor-stroma interaction}
...
Nur die EC sezernieren ja nicht die Cytokine, sie werden ja auch von H838 sezerniert nur eben in geringeren Maßen. 
