...
the average distance to all of its downstream transcription 
factors. This distance metric for a certain receptor
...
distance, we randomly resampled the same number of downstream
